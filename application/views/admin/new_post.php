...
<script type="text/javascript" src="<? echo base_url('/');?>assets/js/vendor/ckeditor/ckeditor.js"></script>
    <div class="container">
        <div class="row">
            <?php echo form_open('dashboard/createpost', array('id' => 'post_form','class' => '')); ?>
            <div class="col-sm-6 col-sm-offset-2">
                <div class="form-box">
                <?php echo $this->session->flashdata('message'); ?>
                <div class="form-group">
                <?php echo form_label('Title','title',array('class' => 'label_form'));?>
                <?php echo form_error('title');?>
                <input id="title" name="title" class="form-control border-form-control" value="<? echo set_value('title'); ?>">
                </div>
                <div class="form-group">
                    <?php echo form_error('content'); ?>
                    <textarea id="content" name="content"><? echo set_value('content'); ?></textarea>
                </div>
