...
class Ion_auth_model extends CI_Model
{
	...
	**/
	public function delete_user($id)
	{
        ...
        //get id of posts created by user
        $array_of_post = $this->post_model->get_by_author($id);

        //Update the author by setting it to 1
        foreach($array_of_post as $post_id){
            $this->post_model->update_author($post_id);
        }
